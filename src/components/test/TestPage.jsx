    ...
    return (
        <Container>
        {
            ...
            ?(<div className='flex flex-col min-h-[85vh]'>
                <div className='flex p-4'>
                    ...
                    <div className='w-1/4 border-2'>
                        <div className='border-b-2'>
                            <h1 className='text-center text-xl border-b-2'> Question Pallete</h1>
                            <div className='flex flex-wrap justify-center m-4 p-2 gap-2'>
                                {/* <QuestionIndex /> */}
                ...
                {/* CONTROLL PANNEL */}
                <div className='mt-auto flex border-t-2 pt-2'>
